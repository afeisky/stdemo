...
public class FrameMain extends javax.swing.JFrame {
    ...
    private void newDLwindow(){
        if (downloadFrame==null || downloadFrame.isClosed()){
             downloadFrame = new FrameDownl();
             desktopPane.add(downloadFrame);
             //Data.logd("---1");
        }        
        //Data.logd("---2");
        downloadFrame.setVisible(true);
        downloadFrame.getFocus();
        try {
    ...
    public static void main(String args[]) {
        ...
        if (1==0){
            ...
            String str="Y:\\stdata\\DownloadD\\sina-000002-2016-1.htm";
            System.out.println("+"+str);
            
            int i=Global.dldata.parser_sina_data(str);
    ...
    private  FrameDownl downloadFrame;
}
